		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Upload Exel ",
									"targetURL": "#minisap2023minisapdeep-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"minisap2023minisapdeep-display": {
								"semanticObject": "minisap2023minisapdeep",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=minisap2023.minisapdeep",
									"url": sap.ui.require.toUrl("minisap2023/minisapdeep")
								}
							}
						}
					}
